<template>
    <div
        class="hidden h-full w-full overflow-hidden rounded-xl bg-slate-800 shadow-2xl ring-1 ring-white/10 ring-inset xl:block"
    >
        <header
        ...
        <div class="scrollbar h-full w-full overflow-auto rounded-tr-lg">
            <ul
                ...
                class="flex h-20 w-full list-none ring-1 ring-white/10 ring-inset odd:bg-slate-800 even:bg-slate-700"
            >

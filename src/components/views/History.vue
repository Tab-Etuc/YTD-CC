<template>
  <div class="flex h-full w-[calc(100%-7rem)]">
    ...
    <div
      class="mx-4 mt-6 h-[90%] w-[28%] rounded-lg bg-slate-800 ring-1 ring-inset ring-white/10"
    >
      <p
        class="my-5 select-none text-center text-3xl font-extrabold leading-tight text-blue-400"
      >
        控制項
      </p>

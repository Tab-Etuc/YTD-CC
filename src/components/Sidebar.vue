<template>
    <div
        class="m-auto mt-6 flex h-[90%] w-20 rounded-xl bg-slate-700 p-4 shadow-2xl ring-1 ring-white/10 ring-inset"
    >
        <div class="relative flex h-full w-full flex-wrap place-content-center justify-center">
            <!-- YTD.CC icon -->
            <img
                class="absolute top-0 my-2 h-11 w-11 rounded-sm select-none"
